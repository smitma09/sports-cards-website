...
//	echo "<h3>" . $auto . "</h3>";
	...
	if ($num_cards == 0) {
		...
		$pages = $num_cards / 50;
		$pages = ceil($pages);
		echo "Should be " . $pages . " pages";

		echo "<div><ul>";
		/* Returns 1 ... n for as many pages as needed, assuming 50 cards per page */
		foreach (range(1, $pages) as $step) {
			echo '<li><a href="' . $step . '">' . $step . '</a></li>';
		}
		echo "</ul></div>";

		/* This section displays cards */
