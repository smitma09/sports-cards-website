...
<head>
	...
	xmlhttp.onreadystatechange = function() {
		...
		url = "getCard_test.php?year="+year+"&playerFirst="+playerFirst+"&playerLast="+playerLast+"&cardSet="+set+"&subset="+subset+"&auto="+autoVar+"&relic="+relicVar+"&patch="+patchVar+"&manu="+manuVar+"&rc="+rcVar+"&sn="+snVar+"&oneofone="+oneofoneVar+"&hof="+hofVar+"&spvar="+spvVar+"&graded="+gradedVar+"&grader="+grader+"&search="+search;
